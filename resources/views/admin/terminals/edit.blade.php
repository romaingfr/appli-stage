            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header iotiz-header">
                        <i class="fas fa-edit me-2"></i> Modifier le terminal
                    </div>

                    <div class="card-body">
                        <form method="POST" action="{{ route('terminals.update', $terminal) }}">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-md-6">
                                    <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name', $terminal->name) }}" required autofocus>
                                    @error('name')
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-md-6">
                                    <input id="model" type="text" class="form-control @error('model') is-invalid @enderror" name="model" value="{{ old('model', $terminal->model) }}" required>
                                    @error('model')
                                    <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-md-6">
                                    <input id="serial_number" type="text" class="form-control @error('serial_number') is-invalid @enderror" name="serial_number" value="{{ old('serial_number', $terminal->serial_number) }}">
                                    @error('serial_number')
                                    <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-md-6">
                                    <input id="phone_number" type="text" class="form-control @error('phone_number') is-invalid @enderror" name="phone_number" value="{{ old('phone_number', $terminal->phone_number) }}">
                                    @error('phone_number')
                                    <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-md-6">
                                    <select id="status" class="form-control @error('status') is-invalid @enderror" name="status" required>
                                        <option value="disponible" {{ old('status', $terminal->status) == 'disponible' ? 'selected' : '' }}>Disponible</option>
                                        <option value="en_service" {{ old('status', $terminal->status) == 'en_service' ? 'selected' : '' }}>En service</option>
                                        <option value="maintenance" {{ old('status', $terminal->status) == 'maintenance' ? 'selected' : '' }}>Maintenance</option>
                                    </select>
                                    @error('status')
                                    <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
